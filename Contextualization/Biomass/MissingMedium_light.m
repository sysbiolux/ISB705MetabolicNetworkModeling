...
[~, rxnid] = find(model.S(ismember(model.mets, medium_exchanges),:));
all_medium_rxns = model.rxns(rxnid)
...
[~, rxnid] = find(model.S(ismember(model.mets, medium_with_missing_metabolites),:));
